...
public class AdminController {
	...
	@DeleteMapping("/deleteMainCategory/{mainCategory}")
	public void deleteMainCategory(@PathVariable("mainCategory") String mainCategory) {
		adminService.deleteMainCategory(mainCategory);
	}
